<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST"){
        try {
            ...
            $stmt = $conn->prepare("INSERT INTO usuarios(userCodigo, userUsername, userPassword, userType, userName, userLastname, userCargo) 
            VALUES(:codigo, :usuario, :clave, :tipo, :nombre, :apellido, :cargo)");
            ...
            if($usuario == "" || $clave == "" || $confirmar == "" || $nombre == "" || $apellido == "" || $cargo == "") { 
